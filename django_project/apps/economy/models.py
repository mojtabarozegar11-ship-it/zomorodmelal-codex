...
class VirtualAssetProject(models.Model):
    ...
    asset_class = models.CharField(max_length=40, choices=ASSET_CLASSES, default="utility")
    ...
    target_jurisdictions = models.TextField(blank=True, help_text="Jurisdictions considered for legal review.")
