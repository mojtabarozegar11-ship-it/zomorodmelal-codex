...
for model in (Asset, MarketDataSnapshot, Strategy, RiskPolicy, Portfolio, Position, OrderIntent, Trade, EconomicReport, EconomicAuditLog, SignalProduct, SignalPurchase, SignalSubscription, SignalCoupon, SignalPerformance, Signal, VirtualAssetProject, EconomicWorkItem, EconomicPublication):
