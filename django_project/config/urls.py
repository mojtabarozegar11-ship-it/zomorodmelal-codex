...
urlpatterns=[
    path("",include("apps.site.urls")),path("",include("apps.economy.urls")),path("studio/",include("apps.studio.urls")),
    path("",include("apps.services.urls")),path("admin/",admin.site.urls),path("api/",include("api.urls")),
