...
INSTALLED_APPS = [
    ...
    "apps.common.apps.CommonConfig", "apps.site", "apps.agriculture", "apps.marketplace", "apps.encyclopedia.apps.EncyclopediaConfig",
    "apps.research", "apps.services", "apps.ai", "apps.economy", "apps.studio", "apps.office",
]
MIDDLEWARE = [
